    ...
    <div className='pt-[3rem] pb-[3rem]'>
        <div className='w-[80%] mx-auto grid grid-cols-1 border-b-[1.5px] border-b-slate-300 pb-[2rem] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[2rem] items-start '>
            ...
            <div className='md:mx-auto mx-0 '>
                ...
                <p className='text-black opacity-80 mb-[1rem] text-[15px] cursor-pointer hover:text-yellow-600'>Press Enquiries</p>
                ...
                <p className='text-black opacity-80 mb-[1rem] text-[15px] cursor-pointer hover:text-yellow-600'>Images 7 B-roll</p>
        ...
        <div className='w-[80%] mx-auto mt-[1rem] text-[15px] opacity-75 '><p className='flex justify-center items-center  text-[#7822E6]'>Copyright @ 2024 by GiantTechy.inc</p></div>
    </div>
  )
}
